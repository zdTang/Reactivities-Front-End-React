...
so that we use create a Route and use "render" property to wrap all these route inside. by doing this, we can display Homepage at the begining without display NavBar.
